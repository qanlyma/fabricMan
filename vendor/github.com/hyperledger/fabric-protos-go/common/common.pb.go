...
type Envelope struct {
	...
	MergePayload 	[]byte `protobuf:"bytes,4,opt,name=mergepayload,proto3" json:"mergepayload,omitempty"`
	Subgraphs    	[]byte `protobuf:"bytes,5,opt,name=subgraphs,proto3" json:"subgraphs,omitempty"`
}
